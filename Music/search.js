...
module.exports = {
  ...
  aliases: ["s"],
  cooldown: 3,
  edesc: `Gõ lệnh này để tìm 5 kết quả đầu tiên cho bài hát của bạn!\nUsage: ${PREFIX}search <TITEL | URL>`,
...
async execute(message,args,client) {
    ...
    if (message.channel.activeCollector)
      return attentionembed(message,"Có một tìm kiếm đang hoạt động!");
    //if the user is not in a voice channel return error
    if (!message.member.voice.channel)
      return attentionembed(message,"Vui lòng tham gia Kênh thoại trước")
    ...
    .setAuthor("Đang tìm kiếm...", "https://cdn.discordapp.com/attachments/778600026280558617/781024479623118878/ezgif.com-gif-maker_1.gif")
    .setColor("#F0EAD6")
    //define the Result Embed
    let resultsEmbed = new MessageEmbed()
      .setTitle("Kết quả cho ")
      .setDescription(`\`${search}\``)
      .setColor("#F0EAD6")
      .setAuthor("Kết quả tìm kiếm!!", "https://cdn.discordapp.com/attachments/778600026280558617/781024479623118878/ezgif.com-gif-maker_1.gif","http://harmonymusic.tk")
      .setFooter("Reaction để chọn","https://cdn.discordapp.com/attachments/778600026280558617/781024479623118878/ezgif.com-gif-maker_1.gif")
    ...
    try {
      ...
      if(response === "error"){
        //send error message
        attentionembed(message,"Hãy sử dụng một biểu tượng cảm xúc phù hợp!");
