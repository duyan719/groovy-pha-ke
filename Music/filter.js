...
module.exports = {
  name: "filter",
  description: "Đặt âm thanh - Hiệu ứng",
  aliases: ["f"],
  cooldown: 3,
  edesc: `Nhập Lệnh này để thay đổi kiểu hiệu ứng âm thanh hiện tại \nUsage: ${PREFIX}filter <Filtertype>`,
  ...
  async execute(message, args, client) {
    ...
    switch (args[0]) {
      ...
      default:
        ...
        .setColor("#F0EAD6")
        .setTitle("Không phải là Bộ lọc hợp lệ, hãy sử dụng một trong những bộ lọc đó: ")
        .setDescription(`
        \`bassboost\`
        \`8D\`
        \`vaporwave\`
